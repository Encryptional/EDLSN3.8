...
def main():
    ...
    seq_fn = '/home/zhangbin/DNA/Datasets/Datasets/RNA-117_Test.txt'
    out_fn = '/home/zhangbin/DNA/Datasets/Datasets/feature/test_RNA_RAA.txt'
    ...
    print(raa.shape)
    np.save('/home/zhangbin/DNA/bio_vec/raa_test_RNA', raa)
