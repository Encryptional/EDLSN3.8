...
def split_data(train_gen, train_bio_vec,train_dyna,emsemble_num):
    label = np.load('/home/zhangbin/DNA/data_label/train_label.npy')
    negative_list = []
    positive_list = []
    ...
    return positive_list_gen, positive_list_bio,positive_list_dyna, sub_list_xl, sub_list_bio, sub_list_dyna
